...
function runBaseTests() {
  px_datetime_input_1 = document.getElementById('px_datetime_input_1');

  suite('Base Automation Tests for px-datetime-input', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-datetime-input fixture is created', function() {
      assert.isTrue(document.getElementById('px_datetime_input_1') !== null);
    });
